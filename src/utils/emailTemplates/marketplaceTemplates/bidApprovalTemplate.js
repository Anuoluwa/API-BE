        ...
        <tr>
          ...
          <td style="width:1000px; height:687px;background: #FFFFFF 0% 0% no-repeat padding-box;opacity: 1;">
            <table>
              ...
              <tr>
                <td style="font-size: 30px;padding-left: 40px; padding-top: 60px; font-family: 'Montserrat', sans-serif;">Hello, <br> You have accepted a offer for your commodity<br/>on <span style="font-weight: bold;">SabexNG Commodity Trading.</span></td>
                <td></td>
              </tr>
              <tr>
