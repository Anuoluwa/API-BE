            ...
            <table>
              ...
              <tr>
                <td style="text-align: center; padding-top: 30px;">
                  <a href="${url}" target="_blank"><button style="color: #ffffff !important; background-color: #000000; text-align: center; padding: 17px 70px; letter-spacing: 1.2px; font-size: 12px; border: 0; border-radius: 5px;">DASHBOARD</button></a>
                </td>
              </tr>
            </table>
          </td>
