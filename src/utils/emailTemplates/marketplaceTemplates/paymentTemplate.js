      ...
      <table style="width:750px;height:1035px;background: #F5F5F5 0% 0% no-repeat padding-box;opacity: 1; color: #354052;">
        ...
        <tr>
          ...
          <td style="width:700px; height:687px;background: #FFFFFF 0% 0% no-repeat padding-box;opacity: 1;">
            <table>
              <tr>
                <td style=" width:120px;padding-left: 40px; padding-bottom: 40px;"><img src="https://i1.wp.com/techpoint.africa/wp-content/uploads/2019/04/sterling-logo.jpg?fit=256%2C256&ssl=1" alt="Sterling logo" width="60"></td>
              </tr>
              <tr>
              </tr>
              <tr>
                <td style="font-size: 1rem; padding-left: 40px; padding-top: 60px; font-family: 'Montserrat', sans-serif;">Thank you for Signing up <br/>to <span style="font-weight: bold;">Sterling Commodity Trading.</span></td>
                <td></td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="text-align: center; padding-top: 30px;">
                  <a href="${url}" target="_blank"><button style="color: #ffffff !important; background-color: #000000; text-align: center; padding: 17px 70px; letter-spacing: 1.2px; font-size: 12px; border: 0; border-radius: 5px;">VERIFY YOUR EMAIL</button></a>
                </td>
              </tr>
            </table>
          </td>
