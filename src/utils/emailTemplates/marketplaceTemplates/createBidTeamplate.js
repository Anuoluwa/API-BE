        ...
        <tr>
          ...
          <td style="width:700px; height:687px;background: #FFFFFF 0% 0% no-repeat padding-box;opacity: 1;">
            <table>
              ...
              <tr>
                <td style="font-size: 1rem; padding-left: 40px; padding-top: 60px; font-family: 'Montserrat', sans-serif;">Thank you, we receive your offer for the commodity <br/>on <span style="font-weight: bold;">SabexNG Commodity Trading.</span></td>
                <td></td>
              </tr>
              <tr>
                <td style="padding-left: 40px; padding-top: 10px; font-size: 18px; font-weight: lighter; font-family: 'Montserrat', sans-serif; text-align: left;">You will receive notifications for this commodity</td>
              </tr>
              <tr>
